...
// ─────────────────────────────────────────────────────────────────────────────
// Fake dart:io HTTP infrastructure (ported from kaspa_resolver_service_test.dart)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  group('KaspaResolverService', () {
    ...
    test('skips failed resolver and tries next', () async {
      ...
      HttpOverrides.global = _FakeHttpOverrides((_) async {
        ...
        return _fakeResponse(200, '{"uid":"abc","url":"wss://second.node/"}');
      });
    ...
    test('uses testnet-10 path for testnet10 network', () async {
      Uri? capturedUri;
